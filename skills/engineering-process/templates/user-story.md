...
### E2E Test Scenarios
- [ ] **Happy path**: [Primary user flow to test]
- [ ] **Error path**: [Error handling to verify]

### Test File Location
- Suggested: `tests/e2e/[feature-name].spec.ts`
- Follow existing patterns in: [reference similar test file]
...
- [ ] E2E test scenarios are defined (for TDD workflow)
