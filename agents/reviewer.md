---
name: reviewer
description: Review code changes for correctness, security, and adherence to standards. Use before finalizing PRs, after implementation phases, or when validating code quality. Provides structured feedback without making changes.
